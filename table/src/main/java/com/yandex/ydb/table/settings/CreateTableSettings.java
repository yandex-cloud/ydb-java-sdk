...
public class CreateTableSettings extends RequestSettings<CreateTableSettings> {
     ...
     * use {@link com.yandex.ydb.table.description.TableDescription#getPartitioningSettings()} instead
     */
    @Nullable
    @Deprecated
    ...
    /**
     * Deprecated, will be removed in further releases
     * use {@link com.yandex.ydb.table.description.TableDescription.Builder#setPartitioningSettings(PartitioningSettings)} instead
     */
    @Deprecated
