...
public final class ExportServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.export.YdbExport.ExportToS3Request,
      com.yandex.ydb.export.YdbExport.ExportToS3Response> getExportToS3Method;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExportToS3",
      requestType = com.yandex.ydb.export.YdbExport.ExportToS3Request.class,
      responseType = com.yandex.ydb.export.YdbExport.ExportToS3Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.export.YdbExport.ExportToS3Request,
      com.yandex.ydb.export.YdbExport.ExportToS3Response> getExportToS3Method() {
    io.grpc.MethodDescriptor<com.yandex.ydb.export.YdbExport.ExportToS3Request, com.yandex.ydb.export.YdbExport.ExportToS3Response> getExportToS3Method;
      ...
      synchronized (ExportServiceGrpc.class) {
        if ((getExportToS3Method = ExportServiceGrpc.getExportToS3Method) == null) {
          ExportServiceGrpc.getExportToS3Method = getExportToS3Method =
              io.grpc.MethodDescriptor.<com.yandex.ydb.export.YdbExport.ExportToS3Request, com.yandex.ydb.export.YdbExport.ExportToS3Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExportToS3"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.export.YdbExport.ExportToS3Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.export.YdbExport.ExportToS3Response.getDefaultInstance()))
  ...
  public static abstract class ExportServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void exportToS3(com.yandex.ydb.export.YdbExport.ExportToS3Request request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.export.YdbExport.ExportToS3Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.export.YdbExport.ExportToS3Request,
                com.yandex.ydb.export.YdbExport.ExportToS3Response>(
  ...
  public static final class ExportServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ExportServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.yandex.ydb.export.YdbExport.ExportToS3Response exportToS3(com.yandex.ydb.export.YdbExport.ExportToS3Request request) {
      return blockingUnaryCall(
  ...
  public static final class ExportServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ExportServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.export.YdbExport.ExportToS3Response> exportToS3(
        com.yandex.ydb.export.YdbExport.ExportToS3Request request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_EXPORT_TO_S3:
          serviceImpl.exportToS3((com.yandex.ydb.export.YdbExport.ExportToS3Request) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.export.YdbExport.ExportToS3Response>) responseObserver);
          break;
        default:
