...
public final class MonitoringServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest,
      com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse> getSelfCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SelfCheck",
      requestType = com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest.class,
      responseType = com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest,
      com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse> getSelfCheckMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest, com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse> getSelfCheckMethod;
      ...
      synchronized (MonitoringServiceGrpc.class) {
        if ((getSelfCheckMethod = MonitoringServiceGrpc.getSelfCheckMethod) == null) {
          MonitoringServiceGrpc.getSelfCheckMethod = getSelfCheckMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest, com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SelfCheck"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse.getDefaultInstance()))
  ...
  public static abstract class MonitoringServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void selfCheck(com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest,
                com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse>(
  ...
  public static final class MonitoringServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MonitoringServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse selfCheck(com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest request) {
  ...
  public static final class MonitoringServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MonitoringServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse> selfCheck(
        com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SELF_CHECK:
          serviceImpl.selfCheck((com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.monitoring.MonitoringProtos.SelfCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MonitoringServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yandex.ydb.monitoring.v1.YdbMonitoringV1.getDescriptor();
    }
