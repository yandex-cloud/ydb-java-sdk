package com.yandex.ydb.yql_internal.v1;
...
public final class YqlInternalServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest,
      com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> getExecDataQueryAstMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExecDataQueryAst",
      requestType = com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest.class,
      responseType = com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest,
      com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> getExecDataQueryAstMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest, com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> getExecDataQueryAstMethod;
      ...
      synchronized (YqlInternalServiceGrpc.class) {
        if ((getExecDataQueryAstMethod = YqlInternalServiceGrpc.getExecDataQueryAstMethod) == null) {
          YqlInternalServiceGrpc.getExecDataQueryAstMethod = getExecDataQueryAstMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest, com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExecDataQueryAst"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest,
      com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> getExplainDataQueryAstMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExplainDataQueryAst",
      requestType = com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest.class,
      responseType = com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest,
      com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> getExplainDataQueryAstMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest, com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> getExplainDataQueryAstMethod;
      ...
      synchronized (YqlInternalServiceGrpc.class) {
        if ((getExplainDataQueryAstMethod = YqlInternalServiceGrpc.getExplainDataQueryAstMethod) == null) {
          YqlInternalServiceGrpc.getExplainDataQueryAstMethod = getExplainDataQueryAstMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest, com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExplainDataQueryAst"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse.getDefaultInstance()))
  ...
  public static abstract class YqlInternalServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void execDataQueryAst(com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getExecDataQueryAstMethod(), responseObserver);
    }

    /**
     */
    public void explainDataQueryAst(com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest,
                com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse>(
                  this, METHODID_EXEC_DATA_QUERY_AST)))
          .addMethod(
            getExplainDataQueryAstMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest,
                com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse>(
  ...
  public static final class YqlInternalServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<YqlInternalServiceBlockingStub> {
    ...
    /**
     */
    public com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse execDataQueryAst(com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest request) {
    ...
    /**
     */
    public com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse explainDataQueryAst(com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest request) {
      return blockingUnaryCall(
  ...
  public static final class YqlInternalServiceFutureStub extends io.grpc.stub.AbstractFutureStub<YqlInternalServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> execDataQueryAst(
        com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> explainDataQueryAst(
        com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXEC_DATA_QUERY_AST:
          serviceImpl.execDataQueryAst((com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse>) responseObserver);
          break;
        case METHODID_EXPLAIN_DATA_QUERY_AST:
          serviceImpl.explainDataQueryAst((com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class YqlInternalServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yandex.ydb.yql_internal.v1.YdbYqlInternal.getDescriptor();
    }
