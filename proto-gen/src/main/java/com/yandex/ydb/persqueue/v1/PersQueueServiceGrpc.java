...
public final class PersQueueServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest,
      com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse> getCreateWriteSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateWriteSession",
      requestType = com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest.class,
      responseType = com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest,
      com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse> getCreateWriteSessionMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest, com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse> getCreateWriteSessionMethod;
      ...
      synchronized (PersQueueServiceGrpc.class) {
        if ((getCreateWriteSessionMethod = PersQueueServiceGrpc.getCreateWriteSessionMethod) == null) {
          PersQueueServiceGrpc.getCreateWriteSessionMethod = getCreateWriteSessionMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest, com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateWriteSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest,
      com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse> getCreateReadSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateReadSession",
      requestType = com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest.class,
      responseType = com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest,
      com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse> getCreateReadSessionMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest, com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse> getCreateReadSessionMethod;
      ...
      synchronized (PersQueueServiceGrpc.class) {
        if ((getCreateReadSessionMethod = PersQueueServiceGrpc.getCreateReadSessionMethod) == null) {
          PersQueueServiceGrpc.getCreateReadSessionMethod = getCreateReadSessionMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest, com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateReadSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse.getDefaultInstance()))
  ...
  public static abstract class PersQueueServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest> createWriteSession(
        io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getCreateWriteSessionMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest> createReadSession(
        io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionRequest,
                com.yandex.ydb.persqueue.YdbPersqueueV1.WriteSessionResponse>(
                  this, METHODID_CREATE_WRITE_SESSION)))
          .addMethod(
            getCreateReadSessionMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionRequest,
                com.yandex.ydb.persqueue.YdbPersqueueV1.ReadSessionResponse>(
