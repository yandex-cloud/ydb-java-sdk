...
public final class ClusterDiscoveryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest,
      com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse> getDiscoverClustersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DiscoverClusters",
      requestType = com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest.class,
      responseType = com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest,
      com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse> getDiscoverClustersMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest, com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse> getDiscoverClustersMethod;
      ...
      synchronized (ClusterDiscoveryServiceGrpc.class) {
        if ((getDiscoverClustersMethod = ClusterDiscoveryServiceGrpc.getDiscoverClustersMethod) == null) {
          ClusterDiscoveryServiceGrpc.getDiscoverClustersMethod = getDiscoverClustersMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest, com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DiscoverClusters"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse.getDefaultInstance()))
  ...
  public static abstract class ClusterDiscoveryServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void discoverClusters(com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest,
                com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse>(
  ...
  public static final class ClusterDiscoveryServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ClusterDiscoveryServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse discoverClusters(com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest request) {
  ...
  public static final class ClusterDiscoveryServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ClusterDiscoveryServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse> discoverClusters(
        com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DISCOVER_CLUSTERS:
          serviceImpl.discoverClusters((com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.cluster_discovery.YdbPersqueueClusterDiscovery.DiscoverClustersResponse>) responseObserver);
          break;
        default:
