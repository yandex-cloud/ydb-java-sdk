...
public final class ScriptingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest,
      com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlResponse> getExecuteYqlMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExecuteYql",
      requestType = com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest.class,
      responseType = com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest,
      com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlResponse> getExecuteYqlMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest, com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlResponse> getExecuteYqlMethod;
      ...
      synchronized (ScriptingServiceGrpc.class) {
        if ((getExecuteYqlMethod = ScriptingServiceGrpc.getExecuteYqlMethod) == null) {
          ScriptingServiceGrpc.getExecuteYqlMethod = getExecuteYqlMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest, com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExecuteYql"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest,
      com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse> getStreamExecuteYqlMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamExecuteYql",
      requestType = com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest.class,
      responseType = com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest,
      com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse> getStreamExecuteYqlMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest, com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse> getStreamExecuteYqlMethod;
      ...
      synchronized (ScriptingServiceGrpc.class) {
        if ((getStreamExecuteYqlMethod = ScriptingServiceGrpc.getStreamExecuteYqlMethod) == null) {
          ScriptingServiceGrpc.getStreamExecuteYqlMethod = getStreamExecuteYqlMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest, com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse.getDefaultInstance()))
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest.class,
      responseType = com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest,
      com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse> getExplainYqlMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest, com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse> getExplainYqlMethod;
      ...
      synchronized (ScriptingServiceGrpc.class) {
        if ((getExplainYqlMethod = ScriptingServiceGrpc.getExplainYqlMethod) == null) {
          ScriptingServiceGrpc.getExplainYqlMethod = getExplainYqlMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest, com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExplainYql"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse.getDefaultInstance()))
  ...
  public static abstract class ScriptingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void executeYql(com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest request,
     ...
     * </pre>
     */
    public void streamExecuteYql(com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest,
                com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse>(
                  this, METHODID_STREAM_EXECUTE_YQL)))
          .addMethod(
            getExplainYqlMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest,
                com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse>(
  ...
  public static final class ScriptingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ScriptingServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse> streamExecuteYql(
        com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest request) {
    ...
    /**
     */
    public com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse explainYql(com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest request) {
      return blockingUnaryCall(
  ...
  public static final class ScriptingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ScriptingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlResponse> executeYql(
        com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlResponse> explainYql(
        com.yandex.ydb.scripting.ScriptingProtos.ExplainYqlRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_STREAM_EXECUTE_YQL:
          serviceImpl.streamExecuteYql((com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.scripting.ScriptingProtos.ExecuteYqlPartialResponse>) responseObserver);
          break;
  ...
  private static abstract class ScriptingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yandex.ydb.scripting.v1.YdbScriptingV1.getDescriptor();
    }
