...
public final class ImportServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.import_.YdbImport.ImportFromS3Request,
      com.yandex.ydb.import_.YdbImport.ImportFromS3Response> getImportFromS3Method;
  ...
  public static io.grpc.MethodDescriptor<com.yandex.ydb.import_.YdbImport.ImportFromS3Request,
      com.yandex.ydb.import_.YdbImport.ImportFromS3Response> getImportFromS3Method() {
    io.grpc.MethodDescriptor<com.yandex.ydb.import_.YdbImport.ImportFromS3Request, com.yandex.ydb.import_.YdbImport.ImportFromS3Response> getImportFromS3Method;
      ...
      synchronized (ImportServiceGrpc.class) {
        if ((getImportFromS3Method = ImportServiceGrpc.getImportFromS3Method) == null) {
          ImportServiceGrpc.getImportFromS3Method = getImportFromS3Method =
              io.grpc.MethodDescriptor.<com.yandex.ydb.import_.YdbImport.ImportFromS3Request, com.yandex.ydb.import_.YdbImport.ImportFromS3Response>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.import_.YdbImport.ImportDataRequest,
      com.yandex.ydb.import_.YdbImport.ImportDataResponse> getImportDataMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.import_.YdbImport.ImportDataRequest,
      com.yandex.ydb.import_.YdbImport.ImportDataResponse> getImportDataMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.import_.YdbImport.ImportDataRequest, com.yandex.ydb.import_.YdbImport.ImportDataResponse> getImportDataMethod;
      ...
      synchronized (ImportServiceGrpc.class) {
        if ((getImportDataMethod = ImportServiceGrpc.getImportDataMethod) == null) {
          ImportServiceGrpc.getImportDataMethod = getImportDataMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.import_.YdbImport.ImportDataRequest, com.yandex.ydb.import_.YdbImport.ImportDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class ImportServiceImplBase implements io.grpc.BindableService {
    ...
    public void importFromS3(com.yandex.ydb.import_.YdbImport.ImportFromS3Request request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.import_.YdbImport.ImportFromS3Response> responseObserver) {
    ...
    public void importData(com.yandex.ydb.import_.YdbImport.ImportDataRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.import_.YdbImport.ImportDataResponse> responseObserver) {
  ...
  public static final class ImportServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ImportServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.import_.YdbImport.ImportFromS3Response> importFromS3(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.import_.YdbImport.ImportDataResponse> importData(
