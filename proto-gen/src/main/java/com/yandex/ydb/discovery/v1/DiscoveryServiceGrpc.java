...
public final class DiscoveryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest,
      com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse> getListEndpointsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListEndpoints",
      requestType = com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest.class,
      responseType = com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest,
      com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse> getListEndpointsMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest, com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse> getListEndpointsMethod;
      ...
      synchronized (DiscoveryServiceGrpc.class) {
        if ((getListEndpointsMethod = DiscoveryServiceGrpc.getListEndpointsMethod) == null) {
          DiscoveryServiceGrpc.getListEndpointsMethod = getListEndpointsMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest, com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListEndpoints"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest,
      com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse> getWhoAmIMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WhoAmI",
      requestType = com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest.class,
      responseType = com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest,
      com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse> getWhoAmIMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest, com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse> getWhoAmIMethod;
    if ((getWhoAmIMethod = DiscoveryServiceGrpc.getWhoAmIMethod) == null) {
      synchronized (DiscoveryServiceGrpc.class) {
        if ((getWhoAmIMethod = DiscoveryServiceGrpc.getWhoAmIMethod) == null) {
          DiscoveryServiceGrpc.getWhoAmIMethod = getWhoAmIMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest, com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WhoAmI"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse.getDefaultInstance()))
  ...
  public static abstract class DiscoveryServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void listEndpoints(com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getListEndpointsMethod(), responseObserver);
    }

    /**
     */
    public void whoAmI(com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest,
                com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse>(
                  this, METHODID_LIST_ENDPOINTS)))
          .addMethod(
            getWhoAmIMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest,
                com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse>(
  ...
  public static final class DiscoveryServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DiscoveryServiceBlockingStub> {
    ...
    /**
     */
    public com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse listEndpoints(com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest request) {
    ...
    /**
     */
    public com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse whoAmI(com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest request) {
      return blockingUnaryCall(
  ...
  public static final class DiscoveryServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DiscoveryServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse> listEndpoints(
        com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse> whoAmI(
        com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_ENDPOINTS:
          serviceImpl.listEndpoints((com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.discovery.DiscoveryProtos.ListEndpointsResponse>) responseObserver);
          break;
        case METHODID_WHO_AM_I:
          serviceImpl.whoAmI((com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.discovery.DiscoveryProtos.WhoAmIResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class DiscoveryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yandex.ydb.discovery.v1.YdbDiscoveryV1.getDescriptor();
    }
