package com.yandex.ydb.backup.v1;
...
public final class BackupServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.yandex.ydb.backup.YdbBackup.CreateBackupRequest,
      com.yandex.ydb.backup.YdbBackup.CreateBackupResponse> METHOD_CREATE_BACKUP =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "Ydb.Backup.V1.BackupService", "CreateBackup"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.yandex.ydb.backup.YdbBackup.CreateBackupRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.yandex.ydb.backup.YdbBackup.CreateBackupResponse.getDefaultInstance()));
  ...
  public static abstract class BackupServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void createBackup(com.yandex.ydb.backup.YdbBackup.CreateBackupRequest request,
        io.grpc.stub.StreamObserver<com.yandex.ydb.backup.YdbBackup.CreateBackupResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yandex.ydb.backup.YdbBackup.CreateBackupRequest,
                com.yandex.ydb.backup.YdbBackup.CreateBackupResponse>(
  ...
  public static final class BackupServiceBlockingStub extends io.grpc.stub.AbstractStub<BackupServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.yandex.ydb.backup.YdbBackup.CreateBackupResponse createBackup(com.yandex.ydb.backup.YdbBackup.CreateBackupRequest request) {
  ...
  public static final class BackupServiceFutureStub extends io.grpc.stub.AbstractStub<BackupServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yandex.ydb.backup.YdbBackup.CreateBackupResponse> createBackup(
        com.yandex.ydb.backup.YdbBackup.CreateBackupRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BACKUP:
          serviceImpl.createBackup((com.yandex.ydb.backup.YdbBackup.CreateBackupRequest) request,
              (io.grpc.stub.StreamObserver<com.yandex.ydb.backup.YdbBackup.CreateBackupResponse>) responseObserver);
          break;
        default:
  ...
  private static final class BackupServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yandex.ydb.backup.v1.YdbBackupV1.getDescriptor();
    }
  }
