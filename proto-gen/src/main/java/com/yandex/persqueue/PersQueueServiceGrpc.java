...
public final class PersQueueServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.Persqueue.WriteRequest,
      com.yandex.ydb.persqueue.Persqueue.WriteResponse> getWriteSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WriteSession",
      requestType = com.yandex.ydb.persqueue.Persqueue.WriteRequest.class,
      responseType = com.yandex.ydb.persqueue.Persqueue.WriteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.Persqueue.WriteRequest,
      com.yandex.ydb.persqueue.Persqueue.WriteResponse> getWriteSessionMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.Persqueue.WriteRequest, com.yandex.ydb.persqueue.Persqueue.WriteResponse> getWriteSessionMethod;
      ...
      synchronized (PersQueueServiceGrpc.class) {
        if ((getWriteSessionMethod = PersQueueServiceGrpc.getWriteSessionMethod) == null) {
          PersQueueServiceGrpc.getWriteSessionMethod = getWriteSessionMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.persqueue.Persqueue.WriteRequest, com.yandex.ydb.persqueue.Persqueue.WriteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WriteSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.Persqueue.WriteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.Persqueue.WriteResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.Persqueue.ReadRequest,
      com.yandex.ydb.persqueue.Persqueue.ReadResponse> getReadSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReadSession",
      requestType = com.yandex.ydb.persqueue.Persqueue.ReadRequest.class,
      responseType = com.yandex.ydb.persqueue.Persqueue.ReadResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.Persqueue.ReadRequest,
      com.yandex.ydb.persqueue.Persqueue.ReadResponse> getReadSessionMethod() {
    io.grpc.MethodDescriptor<com.yandex.ydb.persqueue.Persqueue.ReadRequest, com.yandex.ydb.persqueue.Persqueue.ReadResponse> getReadSessionMethod;
      ...
      synchronized (PersQueueServiceGrpc.class) {
        if ((getReadSessionMethod = PersQueueServiceGrpc.getReadSessionMethod) == null) {
          PersQueueServiceGrpc.getReadSessionMethod = getReadSessionMethod =
              io.grpc.MethodDescriptor.<com.yandex.ydb.persqueue.Persqueue.ReadRequest, com.yandex.ydb.persqueue.Persqueue.ReadResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReadSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.Persqueue.ReadRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yandex.ydb.persqueue.Persqueue.ReadResponse.getDefaultInstance()))
  ...
  public static abstract class PersQueueServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.Persqueue.WriteRequest> writeSession(
        io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.Persqueue.WriteResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getWriteSessionMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.Persqueue.ReadRequest> readSession(
        io.grpc.stub.StreamObserver<com.yandex.ydb.persqueue.Persqueue.ReadResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.yandex.ydb.persqueue.Persqueue.WriteRequest,
                com.yandex.ydb.persqueue.Persqueue.WriteResponse>(
                  this, METHODID_WRITE_SESSION)))
          .addMethod(
            getReadSessionMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.yandex.ydb.persqueue.Persqueue.ReadRequest,
                com.yandex.ydb.persqueue.Persqueue.ReadResponse>(
